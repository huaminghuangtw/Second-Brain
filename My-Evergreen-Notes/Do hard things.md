...
The Sinatra Test: Something passes the test if a single example of success is sufficient to effectively create a halo of "credibility" for future endeavours.
