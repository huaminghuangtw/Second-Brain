...
- Body Language: Forward lean posture towards the speaker signals engagement and positive e
- Energy. Never turn away or sideways, as it signals you are trying to leave a conversation and immediately hurts the energy of a moment.
...
git submodule-remove Daily-Bullet-Journal && git submodule-add git@github.com:huaminghuangtw/Daily-Bullet-Journal.git && git save && git p -f && git submodule-status && git up